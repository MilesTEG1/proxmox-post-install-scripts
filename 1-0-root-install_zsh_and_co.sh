...
printf "\n2. Installation des dépendances : git wget curl neofetch net-tools eza gpg\n"
read -p "Press enter to continue"
sudo apt install -y git wget curl neofetch net-tools gpg
mkdir -p ~/.config/neofetch/
cp ~/"${pbs_config_folder}/neofetch/config.conf" ~/.config/neofetch/
...
cp ~/"${pbs_config_folder}/zshrc_configured_root" ~/.zshrc
...
read -p "Press enter to continue"
mkdir -p /home/${USER_non_ROOT}/${pbs_config_folder}
cp ~/${pbs_config_folder}/zshrc_configured /home/${USER_non_ROOT}/${pbs_config_folder}/
cp ~/${pbs_config_folder}/1-1-non-root-install_zsh_and_co.sh /home/${USER_non_ROOT}/${pbs_config_folder}/
cp -R ~/${pbs_config_folder}/neofetch /home/${USER_non_ROOT}/${pbs_config_folder}/
chown -R "${USER_non_ROOT}":users /home/${USER_non_ROOT}/${pbs_config_folder}
chmod 764 /home/${USER_non_ROOT}/${pbs_config_folder}/1-1-non-root-install_zsh_and_co.sh
